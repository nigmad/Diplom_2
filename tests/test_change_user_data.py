...
class TestChangeUserData:
    ...
    def test_change_user_data_with_authorization(self, field, new_value, expected_field_value, register_user_fixture, clean_up_user):
    ...
    def test_change_user_data_without_authorization(self, field, new_value, expected_field_value, clean_up_user):
